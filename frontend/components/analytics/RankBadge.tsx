...
// ----------------------------------------------------------------------
// Rank 5: Master (Ruby / Fire) - Sharp, aggressive, deeply powerful
// ----------------------------------------------------------------------
const MasterBadge = () => (
  <svg viewBox="0 0 120 120" className="w-full h-full drop-shadow-xl" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="master-dark" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#800000" />
        <stop offset="100%" stopColor="#4d0000" />
      </linearGradient>
      <linearGradient id="master-bright" x1="0%" y1="100%" x2="100%" y2="0%">
        <stop offset="0%" stopColor="#dc143c" />
        <stop offset="100%" stopColor="#ff4500" />
      </linearGradient>
      <filter id="shadow-master">
        <feDropShadow dx="0" dy="8" stdDeviation="6" floodOpacity="0.7" />
      </filter>
    </defs>
    <g filter="url(#shadow-master)">
      {/* Outer Dark Star Backing */}
      <polygon points="60,5 74,40 112,40 82,62 93,98 60,76 27,98 38,62 8,40 46,40" fill="url(#master-dark)" />
      ...
      <polygon points="60,15 70,43 100,43 76,60 85,88 60,72 35,88 44,60 20,43 50,43" fill="url(#master-bright)" />
      
      {/* Precision 3D Star Facets (Light & Shadow) */}
      <polygon points="60,15 70,43 60,60" fill="#ffffff" opacity="0.4" />
      <polygon points="100,43 76,60 60,60" fill="#ffffff" opacity="0.1" />
      <polygon points="85,88 76,60 60,60" fill="#000000" opacity="0.25" />
      <polygon points="85,88 60,72 60,60" fill="#000000" opacity="0.4" />
      <polygon points="35,88 60,72 60,60" fill="#000000" opacity="0.6" />
      <polygon points="35,88 44,60 60,60" fill="#000000" opacity="0.4" />
      <polygon points="20,43 44,60 60,60" fill="#ffffff" opacity="0.1" />
      <polygon points="60,15 50,43 60,60" fill="#ffffff" opacity="0.3" />

      {/* Ruby Center Core */}
      <circle cx="60" cy="60" r="14" fill="#4d0000" stroke="#ffb6c1" strokeWidth="1.5" />
      <polygon points="60,50 68,60 60,70 52,60" fill="#ffb6c1" opacity="0.9" />
    </g>
  </svg>
);
